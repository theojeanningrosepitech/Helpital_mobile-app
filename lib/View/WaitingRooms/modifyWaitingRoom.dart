...
class ModifyWaitingRoom extends StatefulWidget {
  const ModifyWaitingRoom({Key key}) : super(key: key);

  @override
  _ModifyWaitingRoomState createState() => _ModifyWaitingRoomState();
}

class _ModifyWaitingRoomState extends State<ModifyWaitingRoom> {
  @override
